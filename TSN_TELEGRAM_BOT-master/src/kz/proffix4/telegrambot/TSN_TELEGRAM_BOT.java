    ...
    public String doCommand(long chatId, String command) {
        if (command.startsWith("/enter")) {
            ...
            if (param.length > 1) {
                ...
                return "Бот для решения уровнения, создатель Хасиев Магомед ВТиП-302, используйте команду /enter и введите переменные a b x!";
            }
        }
        return "спользуйте команду /enter введите переменные a b x";
    }
